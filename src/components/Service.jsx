                    ...
                    <div className="col-12">
                        ...
                        <div className="service-grid-container mt-50 row-mobile-margin">
                            <div className="service-grid-item text-center">
                                <img className="service-item-img" src="sanofio/src/assets/img/serviceOne.png" alt="service-img-one" />
                            ...
                            <div className="service-grid-item text-center">
                                <img className="service-item-img" src="sanofio/src/assets/img/serviceThree.png" alt="service-img-three" />
                            ...
                            <div className="service-grid-item text-center">
                                <img className="service-item-img" src="sanofio/src/assets/img/serviceFour.png" alt="service-img-four" />
                            ...
                            <div className="service-grid-item text-center">
                                <img className="service-item-img" src="sanofio/src/assets/img/serviceFive.png" alt="service-img-five" />
                            ...
                            <div className="service-grid-item text-center">
                                <img className="service-item-img" src="sanofio/src/assets/img/serviceSix.png" alt="service-img-six" />
                            ...
                            <div className="service-grid-item text-center">
                                <img className="service-item-img" src="sanofio/src/assets/img/serviceSeven.png" alt="service-img-seven" />
                            ...
                            <div className="service-grid-item text-center">
                                <img className="service-item-img" src="sanofio/src/assets/img/serviceEight.png" alt="service-img-eight" />
